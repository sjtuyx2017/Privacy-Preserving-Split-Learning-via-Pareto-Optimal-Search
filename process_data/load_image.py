...
def load_main_dataset(dataset_name, label_name, private_attribute_name, batch_size):
    ...
    # f3 = open(dataPath + 'val_data_clip.pickle', 'rb')
    # f4 = open(dataPath + 'val_label_clip.pickle', 'rb')
    f5 = open(dataPath + 'test_data_clip.pickle', 'rb')
    f6 = open(dataPath + 'test_label_clip.pickle', 'rb')

    X_train = np.array(pickle.load(f1), dtype='float32')
    y_train = pickle.load(f2)
    # X_val = np.array(pickle.load(f3), dtype='float32')
    # y_val = pickle.load(f4)
    X_test = np.array(pickle.load(f5), dtype='float32')
    ...
    # val_loader = construct_data_loader(val_data, val_label, val_private_label, batch_size)
