...
class Client(nn.Module):
    ...
    def get_feature(self, x_private):
        ...
        elif defense == 'GMM-LC' or defense == 'GMM-EPO' or defense == 'GMM-ADV':
            x_private = x_private.to(device)
...
if __name__ == '__main__':
    ...
    directory = './UTKFace_NewGMMLoss_average_results/cloud=gender_attack=white/model-idx=3/defense=GMM-ADV_iter=2000_bs=500_sigma=1_acc-w=0.9_adv-w=0.5/attack=DSA'
    ...
    print("cloud: ", cloud_task)
    print("attack: ", attack_task)
    print("defense method: ", defense)
    print("model index: ", model_idx)

    if defense == 'GMM-LC' or defense == 'GMM-EPO' or defense == 'GMM-ADV':
        sigma = float(split_directory[4].split('_')[3].split('=')[1])

    encoder_path = directory + '/models/encoder_2000.pkl'
    top_model_path = directory + '/models/top_model_2000.pkl'
